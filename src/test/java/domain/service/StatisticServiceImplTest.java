...
class StatisticServiceImplTest {
	...
	void ToStringTest() {
		...
		String s1 = "Statistiques [vues de l'item i123 = 0, vues de la catégorie associée Mobilite = 150, mot général recherché le + courant = cours, avec 1000 vues]" ;
		String s2 = "Statistiques pour l'utilisateur u123 [vues de l'item i123 = 0, vues de la catégorie Mobilite = 150, mot recherché le + courant = cours, avec 100 vues]" ;
