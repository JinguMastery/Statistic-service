...
public class StatisticUser implements Serializable {
	...
	public String toString() {
		return "Statistiques pour l'utilisateur " + usrId + " [vues de l'item "+itemId+ " = " + nClicsItem + ", vues de la catégorie associée " + categorie + " = " + nClicsCategorie + ", mot général le + courant = " + mot + ", avec " + nClicsCategorie + " vues]";
	}
